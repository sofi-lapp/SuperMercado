      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="flex items-end justify-between gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="w-14 h-8 text-center border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                      <button
                        onClick={() => updateCartQuantity(item.product.id, item.quantity + 1)}
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-2 text-red-600 border border-red-600 rounded-lg hover:bg-red-50"
          >
            Vaciar Carrito
          </button>
        </div>
